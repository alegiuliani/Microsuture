...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><span class="glyphicon glyphicon-option-vertical" aria-hidden="true"></span> Sobre a Empresa</h1>
                <ol class="breadcrumb">
                    <li><a href="index.html"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a></li>
                    <li class="active">Sobre a empresa</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-header">Microsuture Indústria Ltda.</h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Alguns de Nossos Clientes</h2>
            </div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="./images/clients/hcsp.png" alt="Hospital das Clínicas de São Paulo">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="./images/clients/hccamp.png" alt="Hospital das Clínicas de Campinas">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
                <img class="img-responsive customer-img" src="./images/clients/hcgoi.jpg" alt="Hospital das Clínicas de Goiás">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6">
